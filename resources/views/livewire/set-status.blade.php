<div
    ...
    <div
        ...
        <form wire:submit.prevent="setStatus" action="" class="space-y-4 px-4 py-6">
            ...
            <div>
                <textarea wire:model="comment" name="update_comment" id="" cols="30" rows="3" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Add an update comment (optional)"></textarea>
            </div>
