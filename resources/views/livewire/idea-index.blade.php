<div
    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        <div class="text-center">
            ...
            <div class="mt-8">
                @if ($hasVoted)
                    <button class="w-20 bg-blue border border-blue hover:bg-blue-hover text-white transition duration-150 ease-in font-bold text-xxs uppercase rounded-xl px-4 py-3">Voted</button>
                @else
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="mx-2 w-full flex flex-col justify-between">
            ...
            <div class="flex items-center md:hidden mt-4 md:mt-0 md">
                ...
                @if ($hasVoted)
                    <button class="w-20 bg-blue font-bold text-xxs text-white uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">Voted</button>
                @else
