<div class="idea-and-buttons-container">
            ...
            <div class="mx-2 w-full">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0 md">
                        ...
                        @if ($hasVoted)
                            <button class="w-20 bg-blue text-white font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">Voted</button>
                        @else
    ...
    <div class="button-container flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button type="button" class="items-center justify-center w-32 h-11 text-xs text-white bg-blue font-semibold rounded-xl border border-gray-200 hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 uppercase">
                    <span>Voted</span>
                </button>
            @else
