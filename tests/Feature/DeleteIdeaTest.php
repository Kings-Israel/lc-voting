...
class DeleteIdeaTest extends TestCase
{
    ...
    public function test_shows_delete_idea_component_when_user_user_has_authorization()
    {
    ...
    public function test_does_not_shows_delete_idea_component_when_user_user_does_not_have_authorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
        $this->actingAs($user)
    ...
    public function test_deleting_an_idea_does_not_work_when_user_has_authorization_because_different_user_created_idea()
    {
        $user = User::factory()->create();
